...
{
    public class ExcelReportGenerator : ITransientDependency
    {
        ...
        public void Run(string fileName, string processedSql, string returnProcessedSql, List<Dictionary<string, string>> headList, List<string> SheetNameList)
        {
